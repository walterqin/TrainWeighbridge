...
* @retval 前缀
*/
QString samplePrefix(weighbridge::SampleType t)
{
    QString prefix;
    switch(t)
    {
    case weighbridge::SampleTypeNormal:
        prefix = profile.statim_sample_prefix();
        break;

    case weighbridge::SampleTypeQc:
        prefix = profile.qc_sample_prefix();
        break;

    case weighbridge::sampleTypeCalibration:
        prefix = profile.cali_sample_prefix();
        break;

    case weighbridge::SampleTypeSim:
        prefix = profile.simu_sample_prefix();
        break;
